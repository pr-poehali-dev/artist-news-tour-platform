        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto space-y-12">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
              <p>
                Современный музыкант, чьё творчество объединяет классические традиции
                и современные звучания. За последние годы выпустил несколько успешных
                альбомов и собрал тысячи поклонников по всему миру.
              </p>
              <p>
                Выступления артиста отличаются особой энергетикой и глубокой связью
                с аудиторией. Каждый концерт — это уникальное музыкальное путешествие,
                которое оставляет неизгладимые впечатления.
              </p>
              <p>
